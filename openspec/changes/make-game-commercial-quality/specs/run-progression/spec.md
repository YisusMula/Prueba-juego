...
El juego SHALL registrar, por cada dificultad, la mejor oleada alcanzada y la mejor puntuación obtenida, y SHALL conservarlos entre sesiones. Al terminar una partida, en victoria o en derrota, el récord de esa dificultad SHALL actualizarse únicamente si el resultado lo supera. Si el almacenamiento no está disponible, el juego SHALL seguir funcionando con normalidad sin récords.

#### Scenario: Un resultado mejor actualiza el récord

- **GIVEN** un récord previo de oleada 12 en una dificultad
- **WHEN** el jugador termina una partida de esa dificultad en la oleada 18
- **THEN** el récord de esa dificultad pasa a ser 18

#### Scenario: Un resultado peor no empeora el récord

- **GIVEN** un récord previo de oleada 18 en una dificultad
- **WHEN** el jugador termina una partida de esa dificultad en la oleada 9
- **THEN** el récord de esa dificultad sigue siendo 18
