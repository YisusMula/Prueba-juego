...
Al seleccionar una torre colocada, el juego SHALL mostrar un panel con su nombre, su nivel actual, su daño y alcance, el coste de la siguiente mejora y un botón de mejora. El botón SHALL aparecer deshabilitado cuando el jugador no tenga oro suficiente o la torre esté en su nivel máximo.

#### Scenario: Panel con datos de la torre

- **WHEN** el jugador selecciona una torre colocada
- **THEN** el panel muestra nombre, nivel, daño, alcance y coste de la siguiente mejora
