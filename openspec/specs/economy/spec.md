...
Toda partida SHALL comenzar con una cantidad de oro inicial fija. El oro SHALL aumentar únicamente al eliminar enemigos, con la recompensa propia del tipo eliminado, y SHALL disminuir al comprar una torre o al mejorarla. El oro nunca SHALL quedar en negativo: cualquier gasto que dejaría el saldo negativo SHALL rechazarse sin efecto.
...
- **WHEN** intenta una compra o mejora de coste 50
